...
- Name: functional\exercise-submit.spec.ts >> Exercise Submission >> should select and submit a multiple choice answer
- Location: tests\functional\exercise-submit.spec.ts:100:7
...
Locator: getByText('Correct!').or(getByText('Not quite'))
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Correct!').or(getByText('Not quite'))
